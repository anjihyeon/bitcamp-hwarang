...
import hwarang.artg.rrboard.service.AirportCodeService;
...
public class ReviewBoardController {
	...
	@Autowired
	private AirportCodeService airservice;
	
	@RequestMapping("/aircode")
	public String showAircodeList(Model model) throws Exception{
		List<AirportCodeDTO> ac = airservice.airportcodeList();
		model.addAttribute("aircodeList", ac);
		return "/review/airportcodeTest";
	}
