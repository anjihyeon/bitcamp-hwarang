				...
				<table class="table">
					<tbody>
						<tr align="right">
							<!-- 개인정보 수정 -->
							<td>
								<p align="left"  style="font-weight: bold;">${member.member_name} 님 </p>
								<hr>
								<button type="button" class="btn btn-outline-dark btn-sm" onclick="location.href='/member/modifyForm'">개인정보 수정</button>
								<button type="button" class="btn btn-outline-dark btn-sm" onclick="location.href='/member/pwForm'">비밀번호 수정</button>
							<!-- 회원 탈퇴 -->
