...
<div class="reivew-div container">
		...
		<form action="write" method="post" id="writeForm" enctype="multipart/form-data">
			...
			<table class="table">
				...
				<tr>
					<td colspan="2">
					<textarea class="form-control" id="content" name="review_content"></textarea>
					<script type="text/javascript">
					 CKEDITOR.replace('content'
					                , {height: 500                                                  
					                 });
					</script>
					<!-- <textarea class="form-control" id="content" name="review_content" rows="10" cols="50"></textarea> -->
					</td>
				</tr>
				<tr>
